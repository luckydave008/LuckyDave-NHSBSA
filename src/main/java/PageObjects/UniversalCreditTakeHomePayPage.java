...
public class UniversalCreditTakeHomePayPage extends Utils {
    ...
    public void verifyHeading() {
        Assert.assertEquals ( loadProp.getProperty ("universalCreditTakeHomePayPageHeading"), Utils.getTextFromElement (_heading));
    }
